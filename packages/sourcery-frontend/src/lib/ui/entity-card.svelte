...
<a
	...
	class="block p-6 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors duration-200"
>
	<div class="space-y-3">
		<div class="flex flex-row gap-2 items-center">
			<div class="bg-blue-600/30 text-blue-200 text-xs font-medium px-2.5 py-1 rounded-md">
				Entity
			</div>
			<div
					...
					: entity.type === 'ORGANIZATION'
						...
						: entity.type === 'LOCATION'
							...
							: entity.type === 'DATE'
								...
								: 'bg-rose-600/30 text-rose-200'} text-xs font-medium px-2.5 py-1 rounded-md"
			>
				{entity.type}
			</div>
		</div>
		...
		<div class="flex items-center gap-2">
			...
			<h3 class="text-lg font-semibold text-white truncate">{entity.value}</h3>
		</div>

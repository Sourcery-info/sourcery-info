...
<div class="bg-gray-900">
	<!-- Mobile menu -->
	{#if isMobileMenuOpen}
	<div class="relative z-50 lg:hidden" role="dialog" aria-modal="true" transition:fade={{ duration: 300 }}>
		...
		<div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
			...
			<div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
				...
				<div class="flex items-center gap-x-4 lg:gap-x-6">
					...
					<!-- Profile dropdown -->
					<div class="relative">
						<button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" on:click={toggleUserMenu}>
						...
						<div class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"
							...
							<a href="/profile" class="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabindex="-1">Your profile</a>
							<a href="/logout" class="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabindex="-1">Sign out</a>

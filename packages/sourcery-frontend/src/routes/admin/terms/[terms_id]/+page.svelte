...
<script lang="ts">
	...
	export let data: { terms: TermsAndConditions; nextVersion: string };
	export let form: {
		message?: string;
	...
	function handleMajorVersionBump() {
		version = incrementVersion(data.terms.version, 'major');
	}
					...
					<div class="mt-2">
						...
						<div class="mt-2 flex items-center justify-between">
							<p class="text-sm text-gray-500 dark:text-gray-400">
								Next version after {data.terms.version}
							</p>
							<button
								type="button"
